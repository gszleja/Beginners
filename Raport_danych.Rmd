...
#Usuwanie wartośći niezawierających "LP" w kolumnie "Loan_ID", i usuwanie tych wierszy
...
hipo_baza <- subset(hipo_baza, Married %in% c("Graduate", "Not Graduate")) #czyszczenie jesli graduate lub Not
