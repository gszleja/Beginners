...
hipo_baza$Property_Area <- factor(hipo_baza$Property_Area, 
                                   levels = c(1, 2, 3), 
                                   labels = c("Zurbanizowany", "średnio Zurbanizowany", "Wieś"))
...
wykres_zarobki_do_miejscowosci <- ggplot(hipo_baza, aes(x = Property_Area, y = ApplicantIncome, fill = Property_Area)) +
  ...
  # Skale kolorów
  scale_fill_manual(values = c("Zurbanizowany" = "lightgreen", "średnio Zurbanizowany" = "violet", "Wieś" = "tomato")) +
  scale_color_manual(values = c("Zurbanizowany" = "darkgreen", "średnio Zurbanizowany" = "purple", "Wieś" = "red")) +
...
wykres_kredyt_do_miejscowosci <- ggplot(hipo_baza, aes(x = Property_Area, y = LoanAmount, fill = Property_Area)) +
  ...
  # Skale kolorów
  scale_fill_manual(values = c("miasto" = "lightgreen", "wieś" = "violet", "turbowies" = "tomato")) +
  scale_color_manual(values = c("miasto" = "darkgreen", "wieś" = "purple", "turbowies" = "red")) +
