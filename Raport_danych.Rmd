...
<div style="
    ...
    margin-left: 50px; /* Przesunięcie do lewej */
...
Celem raportu jest analiza danych dotyczących kredytów mieszkaniowych oraz automatyzacja procesu ich przyznawania. Obecnie firma obsługuje klientów z różnych regionów – miejskich, podmiejskich i wiejskich, a decyzja o przyznaniu kredytu opiera się na wielu czynnikach, takich jak dochód, historia kredytowa, stan cywilny czy liczba osób na utrzymaniu.  

W ramach projektu chcemy stworzyć model pozwalający na segmentację klientów oraz przewidywanie ich kwalifikacji do otrzymania pożyczki. Automatyzacja tego procesu pozwoli na efektywne podejmowanie decyzji w czasie rzeczywistym, co przełoży się na lepszą obsługę klientów oraz optymalizację działań firmy. Do analizy wykorzystamy dostarczony zbiór danych, zawierający istotne informacje o klientach i ich wnioskach kredytowych.
