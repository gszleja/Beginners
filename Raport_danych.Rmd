...
```{r}
aggregate(LoanAmount ~ Self_Employed, data = hipo_baza, FUN = mean, na.rm = TRUE)
#Samozatrudnieni otrzymują wyższe kredyty średnio o około 15.42 jednostek więcej niż osoby niebędące samozatrudnione.
...
podsumowanie <- dfSummary(hipo_baza,
                           method = "render")   # Format renderowany (HTML)
